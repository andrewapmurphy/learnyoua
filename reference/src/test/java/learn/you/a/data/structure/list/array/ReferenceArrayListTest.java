...
public class ReferenceArrayListTest {

	@Test
	public void testConstructor() {
		assertEquals(0, (new ReferenceArrayList<Integer>()).getSize());
		assertEquals(0, (new ReferenceArrayList<Integer>(0)).getSize());
		assertEquals(99, (new ReferenceArrayList<Integer>(99)).getSize());
	}
	...
	public void validSequentialGetSet() {
		...
		final ArrayList<Integer> list = new ReferenceArrayList<Integer>(size);
	...
	public void setRequiresGrow() {
		final ArrayList<Integer> list = new ReferenceArrayList<Integer>();
	...
	public void resizeLargerTest() {
		...
		final ArrayList<Integer> list = new ReferenceArrayList<Integer>(originalSize);
